...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="http://localhost/edmd/public/pages/Admin/dashboard.php" class="active">
            <i class="fas fa-qrcode"></i>
            <span>Dashboard</span>
        </a>

        <a href="http://localhost/edmd/public/view/admin/notes.php">
            <i class="far fa-question-circle"></i>
            <span>Notes</span>
        </a>

        <a href="http://localhost/edmd/public/components/backup/backup.php">
